...
app.service("utils", function ($http, $q, baseUrl, $timeout) {
    ...
    return {
        ...
        // uploadBind:function(selecter,callback){
        //     qiniu.bind(angular.element(selecter), {
        //         filter: 'image',
        //         trigger:'click'
        //     })
        ...
        //             console.log(data)
        //             var imagesBucket = qiniu.bucket('iot_use_clould'.getTime(), {
        //                 putToken: data.token
        //             });
        //             imagesBucket.putFile(data.file_name, file, function(err, reply) {
        //                 if (err) {
