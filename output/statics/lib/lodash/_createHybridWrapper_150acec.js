var composeArgs = require('lib/lodash/_composeArgs'),
    composeArgsRight = require('lib/lodash/_composeArgsRight'),
    countHolders = require('lib/lodash/_countHolders'),
    ...
    reorder = require('lib/lodash/_reorder'),
